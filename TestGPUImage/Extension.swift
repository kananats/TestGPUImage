...
extension Signal.Observer where Error == NoError {
    
    @discardableResult
    public static func <~ <Source: BindingSource> (provider: Signal.Observer, source: Source) -> Disposable? where Source.Value == Value, Source.Error == NoError {
