...
/// `UIView` that conform to the `Reusable` protocol must provide its `reuseIdentifier` to be used with `UICollectionView.register(_:forCellWithReuseIdentifier:)` or `UITableView.register(_:forCellWithReuseIdentifier:)`
